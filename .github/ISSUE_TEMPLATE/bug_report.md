...
1. Review the [troubelshooting section](https://github.com/blairham/ghorg#troubleshooting) in the README.md
1. Review the [examples](https://github.com/blairham/ghorg/tree/master/examples) directory for example commands
